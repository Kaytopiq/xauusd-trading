...
```bash
bash /Users/kiokuvisual/Documents/tradingview/.agents/skills/xauusd-trading/scripts/fetch_price.sh
```
...
bash /Users/kiokuvisual/Documents/tradingview/.agents/skills/xauusd-trading/scripts/fetch_candles.sh 5min 30

# 15-minute candles (for trend/structure)
bash /Users/kiokuvisual/Documents/tradingview/.agents/skills/xauusd-trading/scripts/fetch_candles.sh 15min 20

# 1-minute candles (for micro entries)
bash /Users/kiokuvisual/Documents/tradingview/.agents/skills/xauusd-trading/scripts/fetch_candles.sh 1min 40
```
...
```bash
bash /Users/kiokuvisual/Documents/tradingview/.agents/skills/xauusd-trading/scripts/fetch_gold.sh 5m 1d 50
```
...
3. Test: `bash /Users/kiokuvisual/Documents/tradingview/.agents/skills/xauusd-trading/scripts/fetch_candles.sh 5min 10`
...
2. **Fetch data** — you MUST run BOTH scripts every cycle:
   ...
   bash /Users/kiokuvisual/Documents/tradingview/.agents/skills/xauusd-trading/scripts/fetch_price.sh
   bash /Users/kiokuvisual/Documents/tradingview/.agents/skills/xauusd-trading/scripts/fetch_candles.sh 5min 15
   ```
   ...
   - Every 3-5 cycles, also fetch 15m candles for trend context:
     ```bash
     bash /Users/kiokuvisual/Documents/tradingview/.agents/skills/xauusd-trading/scripts/fetch_candles.sh 15min 10
     ```
